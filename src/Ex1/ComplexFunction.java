...
public class ComplexFunction implements complex_function {
	...
	/**
	 * Constractor for operation, function left and right
	 * @param operation
	 * @param left
	 * @param right
	 */
	...
	/**
	 * constractor for operation(String), function left and right
	 * @param operation
	 * @param left
	 * @param right
	 */
	...
	@Override
	/**
	 * Calculate f(x) with operation and return the result
	 */
	...
	@Override
	/**
	 *  Get a string function and return function
	 */
